 ...
 */
export function allocateBlueprintName(state: ContentManager.ContentManager, base = 'blueprint'): string {
...
export type SaveBlueprintResult = { ok: true; sceneId: string; overwritten: boolean } | { ok: false; error: string };
