...
export function ActiveBlockPane() {
    ...
    if (!room) return <div className="px-2 py-2 text-[10px] font-mono text-neutral-400">no scene loaded</div>;
    ...
    if (!activeDef) {
        return <div className="px-2 py-2 text-[10px] font-mono text-neutral-400 italic">none selected</div>;
    }
    ...
    return (
        <div className="p-2 flex flex-col gap-1.5">
            <div className="flex items-center gap-2">
                ...
                <div className="text-[12px] font-mono font-semibold text-neutral-800">{activeDef.id}</div>
            </div>
