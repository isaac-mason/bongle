...
export function DebugPane() {
    ...
    return (
        <div className="flex flex-col gap-1 px-3 py-2">
            <label className="flex items-center gap-2 text-[10px] font-mono text-fg cursor-pointer select-none">
                <input
                    type="checkbox"
            ...
            {netSimEnabled && (
                <>
                    <div className="flex items-center gap-1 pl-5">
                        <span className="text-[10px] font-mono text-fg w-12 shrink-0">rtt ms</span>
