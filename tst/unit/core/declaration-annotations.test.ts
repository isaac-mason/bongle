...
//
// `block()`, `blockTexture()`, `sound()` et al register into the engine registries when their
...
// and the helpers that appear in the arguments (`asset`, `draw`) need it too. One unannotated
// call anywhere inside `cube('kit:stone', { textures: blockTextures.stone })` keeps the whole
// statement.
//
...
const NAMED: [file: string, names: string[]][] = [
    ['api/asset.ts', ['asset']],
    ['core/voxels/blocks.ts', ['block', 'blockTexture']],
    ['core/sounds/sounds.ts', ['sound']],
    ['core/sprites/sprites.ts', ['sprite']],
    ['core/sprites/draw.ts', ['draw']],
    ['core/models/models.ts', ['model']],
    ['core/particles/particles.ts', ['particle']],
];
